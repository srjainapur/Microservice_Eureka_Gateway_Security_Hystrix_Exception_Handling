...
import com.java.api.gateway.security.JwtTokenProvider;
	...
	public String login(String username, String password) {
		try {
			...
			String token = jwtTokenProvider.createToken(username,
					user.getRole().stream().map((Role role) -> "ROLE_" + role.getRole()).filter(Objects::nonNull).collect(Collectors.toList()));
			return token;
